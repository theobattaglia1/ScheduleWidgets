...
final class AppGroupStore {
    ...
    private enum FileName: String {
        ...
        case enabledCalendars = "enabledCalendars.json"
    }
    ...
    private init() {
        ...
        if let url = containerURL {
            ...
            // On macOS, ensure directory is accessible by widget extension
            #if os(macOS)
    ...
    private func write<T: Encodable>(_ value: T, to fileName: FileName) {
        ...
        do {
            ...
            // On macOS, ensure file is readable by widget extension
            #if os(macOS)
    ...
    func saveEnabledCalendars(_ calendars: Set<String>) {
        let array = Array(calendars)
        write(array, to: .enabledCalendars)
    }
    
    func loadEnabledCalendars() -> Set<String>? {
        guard let array = read([String].self, from: .enabledCalendars) else {
            return nil
        }
        return Set(array)
    }
